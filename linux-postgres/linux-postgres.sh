...
[bk]
stbkp01 ansible_ssh_user=clint ansible_ssh_pass="H@wk3y3" ansible_ssh_key="/home/clint/.ssh/id_rsa.pub" ansible_become_user=root ansible_become_pass="H@wk3y3" 
[apps]
...
[db]
stbkp01 ansible_ssh_user=peter ansible_ssh_pass="Sp!dy" ansible_ssh_key="/home/clint/.ssh/id_rsa.pub" ansible_become_user=root ansible_become_pass="H@wk3y3" ' \
> ${project_path}/hosts
